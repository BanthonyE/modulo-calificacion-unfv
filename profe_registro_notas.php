        ...
        if(isset($_GET['id'])){
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <?php foreach ($alumnos as $index => $alumno) :?>
                    ...
                    <input type="hidden" value="<?php echo $id_materia ?>" name="id_curso">
                    ...
                    <?php if(strcmp(''.$alumno['idalumno'],''.$index_id_alumno)){ ?>
                        ...
                        <tr>
                            ...
                            if(existeNota($alumno['idalumno'],$id_curso,$conn) > 0){
                                    ...
                                    $notas = $conn->prepare("select id, nota1 from notas where id_alumno = ".$alumno['idalumno']." and id_materia = ".$id_curso);
                                    $notas->execute();
                                    ...
                                    foreach ($registrosnotas as $eval => $nota){
                                        ...
                                        echo '<td><input type="text" maxlength="5" value="'.$nota['nota1'].'" name="evaluacion' . $eval . 'alumno' . $index . '" class="txtnota"></td>';
                                    }
                                    ...
                                    if($num_eval > $num_notas){
                                        ...
                                        for($i = $num_notas; $i < $dif + $num_notas; $i++) {
                                            ...
                                            echo '<td><input type="text" maxlength="5" value="'.$nota['nota1'].'" name="evaluacion' . $i . 'alumno' . $index . '" class="txtnota"></td>';
                                        }
                                    }                                
                                }else {
                                    //extrayendo el numero de evaluaciones para esa materia seleccionada

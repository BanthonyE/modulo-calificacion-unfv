...
<title>Notas | Registro de Notas</title>
    <meta name="description" content="Registro de Notas de Federico Villarreal" />
...
<div class="body">
    <div class="panel">
            ...
            ?>
            <form method="get" class="form" action="profe_registro_notas.php">

                <label>Seleccione el Periodo</label><br>
                <select name="periodo" required>
                    <?php $aux=""; foreach ($materias as $periodo):?>
                        <?php if(strcmp(''.$periodo['id_periodo'],''.$aux)){ ?>
                            <option value="<?php echo $periodo['id_periodo']?>"><?php echo $periodo['id_periodo'] ?></option>
                        <?php } ?>
                    <?php $aux=$periodo['id_periodo'];  endforeach;?>
                </select>
                <br><br>
